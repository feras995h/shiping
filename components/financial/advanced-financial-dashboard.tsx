...
export default function AdvancedFinancialDashboard() {
  ...
  const fetchFinancialData = async (showRefresh = false) => {
    try {
      ...
      const [metricsRes, ratiosRes, cashFlowRes] = await Promise.all([
        fetch('/api/financial/metrics'),
        fetch('/api/accounting/advanced-reports?type=ratios'),
        fetch('/api/accounting/advanced-reports?type=cashflow')
      ])

      const [metricsData, ratiosData, cashFlowData] = await Promise.all([
        metricsRes.json(),
        ratiosRes.json(),
        cashFlowRes.json()
      ])
      ...
      if (ratiosData.success) {
        setRatios(ratiosData.data.ratios || [])
      }

      if (cashFlowData.success) {
        setCashFlow(cashFlowData.data.cashFlowStatement)
      }
    ...
    <div className="space-y-6">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
        ...
        <TabsContent value="overview" className="space-y-6">
          {metrics && (
            <SimpleStaggeredCards className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <AnimatedCard variant="gold" animation="slideUp" delay={0.1} className="p-6">
                <div className="flex items-center justify-between">
                  <div>
              ...
              <AnimatedCard variant="gold" animation="slideUp" delay={0.2} className="p-6">
                <div className="flex items-center justify-between">
                  <div>
              ...
              <AnimatedCard variant="gold" animation="slideUp" delay={0.3} className="p-6">
                <div className="flex items-center justify-between">
                  <div>
        ...
        <TabsContent value="cashflow" className="space-y-6">
          {cashFlow && (
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <AnimatedCard variant="gold" className="p-6">
                <CardHeader>
              ...
              <CardContent>
                <div className="space-y-6">
                  <div>
                    ...
                    <AnimatedProgressBar progress={75} color="bg-green-500" className="h-2" />
                  </div>
                  ...
                  <div>
                    ...
                    <AnimatedProgressBar progress={85} color="bg-blue-500" className="h-2" />
                  </div>
                  ...
                  <div>
                    ...
                    <AnimatedProgressBar progress={92} color="bg-purple-500" className="h-2" />
                  </div>
                  ...
                  <div>
                    ...
                    <AnimatedProgressBar progress={88} color="bg-amber-500" className="h-2" />
                  </div>
                </div>
              </CardContent>
            </AnimatedCard>
